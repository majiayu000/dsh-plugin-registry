...
(function () {
  ...
  var en = {
    ...
    '自动发现要求根目录或子包 package.json 声明 dsh.bundle，且 patch 里至少有一行带 id 和 name 的插件。': 'Auto-discovery requires dsh.bundle in the root or a subpackage package.json, and the patch must declare at least one plugin row with id and name.',
    ...
    '声明有效的 dsh.bundle': 'Declares a valid dsh.bundle', 'Patch 文件存在且含插件行': 'Patch file exists and contains plugin rows', '仓库未归档且不是 Fork': 'Repository is unarchived and not a fork',
