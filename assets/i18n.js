...
(function () {
  ...
  var en = {
    ...
    , '插件作者': 'Plugin authors', '自动发现': 'Auto-discovered', '仅看精选': 'Curated only',
    ...
    '精选': 'Curated', '查看 GitHub': 'View on GitHub', '为什么被收录': 'Why it is listed', '社区数据': 'Community data',
    ...
    'manifest 验证通过': 'Manifest verified', '按可安装插件数量': 'By installable plugin count', '来源构成': 'Source composition',
    '精选与自动发现': 'Curated and auto-discovered', '数据生成于：': 'Generated: ', '按收录插件的 Stars 合计': 'Total Stars across listed plugins',
