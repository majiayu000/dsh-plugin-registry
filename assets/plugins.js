  ...
  function row(plugin, index) {
    ...
    element.innerHTML =
      ...
      '<div class="prow-main">' +
        ...
        '<div class="prow-signals">' + topicSignals(plugin) + pluginSignals(plugin) + (updatedLabel(plugin.pushedAt) ? '<span class="prow-updated">' + updatedLabel(plugin.pushedAt) + '</span>' : '') + '</div>' +
      '</div>' +
