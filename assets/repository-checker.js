...
const CHECKER_COPY = {
  'zh-CN': {
    ...
    curated: '这个仓库已通过精选目录收录，但还不符合自动发现契约；现有收录不会受影响。',
  ...
  'en-US': {
    ...
    curated: 'This repository is already in the curated catalog, but it does not yet meet the auto-discovery contract. Its current listing is unaffected.',
