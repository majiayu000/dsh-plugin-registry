...
const CHECKER_COPY = {
  'zh-CN': {
    ...
    incomplete: '还有项目未通过。请对照自动发现条件修复后重新检查。',
    ...
    patch_not_array: 'Patch 文件必须是顶层 YAML 数组。',
  ...
  'en-US': {
    ...
    incomplete: 'Some checks failed. Fix the auto-discovery requirements and check again.',
    ...
    patch_not_array: 'The patch file must be a top-level YAML array.',
