# Harness Registry repository metadata

This record follows the ShipWise discoverability checklist. Public GitHub settings were verified on 2026-08-15; file-based items refer to the current local branch until they are pushed.
...
- Target users: DeepSeek Harness users choosing plugins and plugin authors checking discoverability eligibility
...
| Surface | Status | Evidence or next action |
|---|---|---|
| Description | verified | Public GitHub repository setting checked with `gh repo view` |
| Topics | verified | Nine relevant topics applied and checked with `gh repo view` |
...
- No largest, safest, official, or security-audited claim is made.
